...
(function (global, factory) {
  ...
  ChartInternal.prototype.initTooltip = function () {
    ...
    //changed by widestage position relative to position absolute from
    ...
    $$.tooltip = $$.selectChart.style("position", "absolute").append("div").attr('class', CLASS.tooltipContainer).style("position", "absolute").style("pointer-events", "none").style("display", "none"); // Show tooltip if needed
