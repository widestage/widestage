...
app.directive('wstColorSmall', function($compile) {
return {
    transclude: true,
    scope: {
        onChangeColor: '&',
   ...
   template: '<div class="btn-group">'
                    +'<span type="button"  class="input-group-addon icp icp-dd btn btn-primary dropdown-toggle iconpicker-element" data-selected="fa-car" data-toggle="dropdown" ng-disabled="{{ngDisabled}}" style="width:32px;height:32px; margin-bottom:0px;background-color:{{selectedColor}}">'
...
require: 'ngModel',
    ...
    compile: function (element, attrs) {
        ...
        $scope.$watch('side', function(){
              ...
              if ($scope.side = 'right')
                  $scope.dropSide = 'dropdown-menu-right';
