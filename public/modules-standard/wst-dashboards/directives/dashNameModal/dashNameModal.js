app.service('dashboardNameModal', ['$uibModal', function($uibModal) {
      ...
      var modalDefaults = {
          ...
          keyboard: true,
          modalFade: true,
          templateUrl: 'wst-dashboards/directives/dashNameModal/dashNameModal.html'
      };
          ...
          if (!tempModalDefaults.controller) {
              tempModalDefaults.controller = function ($scope, $uibModalInstance,$rootScope, connection, $i18next) {
                  ...
                  if ($scope.modalOptions.object)
                      {
                        $scope.dashboard = $scope.modalOptions.object;
                      }
